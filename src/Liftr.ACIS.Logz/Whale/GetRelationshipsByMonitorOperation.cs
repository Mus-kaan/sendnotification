...
namespace Microsoft.Liftr.ACIS.Logz
{
    ...
    /// </summary>
    public class GetRelationshipsByMonitorOperation : AcisSMEOperation
    {
        public override string OperationName => "GetRelationshipsByMonitor";
        ...
        /// </summary>
        public IAcisSMEOperationResponse GetRelationshipsByMonitor(string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return GetRelationshipsByMonitorAsync(monitorId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> GetRelationshipsByMonitorAsync(string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(GetRelationshipsByMonitor), parameters: monitorId);
            if (result.Succeeded)
            {
