...
namespace Microsoft.Liftr.ACIS.Logz
{
    ...
    /// </summary>
    public class RemoveRelationshipByResourceOperation : AcisSMEOperation
    {
        public override string OperationName => "RemoveRelationshipByResource";
        ...
        public override IEnumerable<IAcisSMEParameterRef> Parameters => new[]
            {
                ParamRefFromParam.Get<MonitoredResourceIdTextParameter>(isOptional: false),
        ...
        /// </summary>
        public IAcisSMEOperationResponse RemoveRelationshipByResource(string monitoredresourceId, string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return RemoveRelationshipByResourceAsync(monitoredresourceId, monitorId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> RemoveRelationshipByResourceAsync(string monitoredresourceId, string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(RemoveRelationshipByResource), parameters: message.ToJson());
            if (result.Succeeded)
            {
