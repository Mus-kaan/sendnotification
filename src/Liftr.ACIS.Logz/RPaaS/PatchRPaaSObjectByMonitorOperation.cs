...
namespace Microsoft.Liftr.ACIS.Logz
{
    ...
    /// </summary>
    public class PatchRPaaSObjectByMonitorOperation : AcisSMEOperation
    {
        public override string OperationName => "PatchRPaaSObjectByMonitor";
        ...
        public override IEnumerable<IAcisSMEParameterRef> Parameters => new[]
            {
                ...
                ParamRefFromParam.Get<RPaaSObjectTextParameter>(isOptional: false),
            };
        ...
        /// </summary>
        public IAcisSMEOperationResponse PatchRPaaSObjectByMonitor(string monitorId, string RPaaSobject, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return PatchRPaaSObjectByMonitorAsync(monitorId, RPaaSobject, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> PatchRPaaSObjectByMonitorAsync(string monitorId, string RPaaSobject, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            PatchRPaaSObjectMessage message = new PatchRPaaSObjectMessage()
            {
                MonitorId = monitorId,
                RPaaSobject = RPaaSobject,
            };
            ...
            var result = await coordinator.StartWorkAsync(nameof(PatchRPaaSObjectByMonitor), parameters: message.ToJson());
            if (result.Succeeded)
            {
