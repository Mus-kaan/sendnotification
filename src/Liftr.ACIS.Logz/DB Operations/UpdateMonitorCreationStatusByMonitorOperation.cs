...
namespace Microsoft.Liftr.ACIS.Logz
{
    ...
    public class UpdateMonitorCreationStatusByMonitorOperation : AcisSMEOperation
    {
        ...
        /// </summary>
        public IAcisSMEOperationResponse UpdateMonitorCreationStatusByMonitor(string monitorId, string monitorCreationStatusObject, bool APIToken, bool shippingToken, bool marketplaceResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return UpdateMonitorCreationStatusByMonitorAsync(monitorId, monitorCreationStatusObject, APIToken, shippingToken, marketplaceResourceId, extension, updater, endpoint).Result;
        }
