...
namespace Microsoft.Liftr.ACIS.Logz
{
    public class GetLogzMonitorOperation : AcisSMEOperation
    {
        ...
        /// </summary>
        public IAcisSMEOperationResponse GetLogzMonitor(string monitorResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return GetLogzMonitorAsync(monitorResourceId, extension, updater, endpoint).Result;
        }
...
#pragma warning disable CA1822 // Mark members as static
        public async Task<IAcisSMEOperationResponse> GetLogzMonitorAsync(string monitorResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
