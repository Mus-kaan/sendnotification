...
namespace Microsoft.Liftr.ACIS.Nginx.Partner
{
    public class GetOrgForSubIdOperation : AcisSMEOperation
    {
        ...
        /// <returns></returns>
        public IAcisSMEOperationResponse GetOrgForSubId(string subscriptionId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null) => Common.Utilities.CallOperationAsync(Constants.GetPartnerOrgInfo, extension, updater, endpoint, parameters: subscriptionId).Result;
    }
}
