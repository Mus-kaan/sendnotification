...
namespace Microsoft.Liftr.ACIS.Nginx.Marketplace
{
    ...
    public class GetMarketplaceResourceByDeploymentOperation : AcisSMEOperation
    {
        ...
        /// <returns></returns>
        public IAcisSMEOperationResponse GetMarketplaceResourceByDeployment(string deploymentId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null) => Common.Utilities.CallOperationAsync(Constants.GetMarketplaceResourceByDeployment, extension, updater, endpoint, parameters: deploymentId).Result;
    }
}
