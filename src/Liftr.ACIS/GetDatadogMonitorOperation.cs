...
namespace Microsoft.Liftr.ACIS
{
    ...
    /// </summary>
    public class GetDatadogMonitorOperation : AcisSMEOperation
    {
        ...
        /// </summary>
        public IAcisSMEOperationResponse GetDatadogMonitor(string monitorResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return GetDatadogMonitorAsync(monitorResourceId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> GetDatadogMonitorAsync(string monitorResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(GetDatadogMonitor), parameters: monitorResourceId);
            if (result.Succeeded)
            {
