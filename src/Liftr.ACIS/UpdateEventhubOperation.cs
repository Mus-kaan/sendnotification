...
using Microsoft.Liftr.ACIS.Params;
...
namespace Microsoft.Liftr.ACIS
{
    ...
    /// </summary>
    public class UpdateEventhubOperation : AcisSMEOperation
    {
        public override string OperationName => "UpdateEventhub";
        ...
        {
                ParamRefFromParam.Get<EventhubNamespaceNameParameter>(isOptional: false),
                ParamRefFromParam.Get<EvhIngestEnabledParameter>(isOptional: false),
                ParamRefFromParam.Get<EvhReadEnabledParameter>(isOptional: false),
        };
        ...
        /// </summary>
        public IAcisSMEOperationResponse UpdateEventhub(
        ...
        {
            return UpdateEventhubAsync(eventhubNamespaceName, ingestEnable, readEnable, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> UpdateEventhubAsync(
            string eventhubNamespaceName,
            bool ingestEnable,
            bool readEnable,
            IAcisServiceManagementExtension extension = null,
            ...
            IAcisSMEEndpoint endpoint = null)
        {
            ...
            UpdateEventhubMessage msg = new UpdateEventhubMessage
            {
                EventhubNamespaceName = eventhubNamespaceName,
                IngestEnabled = ingestEnable,
                Active = readEnable,
            };
            ...
            var result = await coordinator.StartWorkAsync(nameof(UpdateEventhub), parameters: msg.ToJson());
            if (result.Succeeded)
            {
