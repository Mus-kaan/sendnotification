...
{
    public class DynatraceExtension : AcisServiceManagementExtension
    {
        private string _serviceNameConst = "Dynatrace";
        ...
        public override bool OnLoad()
        {
            ...
            logger.LogInfo($"Just loaded {nameof(DynatraceExtension)}");
