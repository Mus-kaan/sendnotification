...
{
    public class GetDynatraceMonitorOperation : AcisSMEOperation
    {
        /// <summary>
        /// Name of the operation. This is prominently visible from Jarvis. One search an operation by name.
        /// </summary>
        public override string OperationName { get => "GetDynatraceMonitor"; }

        /// <summary>
        /// Each operation belongs to an operation group. This is how we associate an operation with operation group.
        /// </summary>
        public override IAcisSMEOperationGroup OperationGroup { get => new DynatraceOperationGroup(); }
        ...
        /// for example this class name is GetDynatraceMonitorOperation and thus method name is GetDynatraceMonitor()
        /// </summary>
        ...
        /// <returns></returns>
        public IAcisSMEOperationResponse GetDynatraceMonitor(string monitorResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return GetDynatraceMonitorAsync(monitorResourceId, extension, updater, endpoint).Result;
        }

#pragma warning disable CA1822 // Mark members as static
        public async Task<IAcisSMEOperationResponse> GetDynatraceMonitorAsync(string monitorResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
#pragma warning restore CA1822 // Mark members as static
        {
            ...
            var result = await coordinator.StartWorkAsync(nameof(GetDynatraceMonitor), parameters: monitorResourceId);
            if (result.Succeeded)
            {
