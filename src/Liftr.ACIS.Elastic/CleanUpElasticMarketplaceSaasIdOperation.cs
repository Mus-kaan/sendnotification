...
{
    public class CleanUpElasticMarketplaceSaasIdOperation : AcisSMEOperation
    {
        /// <summary>
        /// Name of the operation. This is prominently visible from Jarvis. One search an operation by name.
        /// </summary>
        public override string OperationName { get => "CleanUpElasticMarketplaceSaasId"; }
        ...
        /// </summary>
        public IAcisSMEOperationResponse CleanUpElasticMarketplaceSaasId(string marketplaceSaasId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return CleanUpElasticMarketplaceSaasIdAsync(marketplaceSaasId, extension, updater, endpoint).Result;
        }
...
#pragma warning disable CA1822 // Mark members as static
        public async Task<IAcisSMEOperationResponse> CleanUpElasticMarketplaceSaasIdAsync(string marketplaceSaasId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
#pragma warning restore CA1822 // Mark members as static
        {
            ...
            var result = await coordinator.StartWorkAsync(nameof(CleanUpElasticMarketplaceSaasId), parameters: marketplaceSaasId);
            if (result.Succeeded)
            {
