...
{
    public class CreateActivateMarketplaceOperation : AcisSMEOperation
    {
        /// <summary>
        /// Name of the operation. This is prominently visible from Jarvis. One search an operation by name.
        /// </summary>
        public override string OperationName { get => "CreateActivateMarketplace"; }
        ...
        /// </summary>
        public IAcisSMEOperationResponse CreateActivateMarketplace(string marketplaceSaasId, string elasticResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return CreateActivateMarketplaceAsync(marketplaceSaasId, elasticResourceId, extension, updater, endpoint).Result;
        }
...
#pragma warning disable CA1822 // Mark members as static
        public async Task<IAcisSMEOperationResponse> CreateActivateMarketplaceAsync(string marketplaceSaasId, string elasticResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
