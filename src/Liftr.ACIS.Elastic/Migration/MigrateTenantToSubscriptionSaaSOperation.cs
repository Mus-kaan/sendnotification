...
namespace Microsoft.Liftr.ACIS.Elastic.Migration
{
    public class MigrateTenantToSubscriptionSaaSOperation : AcisSMEOperation
    {
        ...
        /// </summary>
        public override string OperationName { get => "Migrate SaaS Resource from Tenant level to Subscription Level"; }

        /// <summary>
        /// Each operation belongs to an operation group. This is how we associate an operation with operation group.
        /// </summary>
        public override IAcisSMEOperationGroup OperationGroup { get => new MigrationOperationGroup(); }
