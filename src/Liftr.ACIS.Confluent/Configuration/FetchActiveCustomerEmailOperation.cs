...
{
    /// <summary>
    /// FetchActiveCustomerEmail Operation provides a list of active customer email. Expected input is tenantId and resourceId.
    /// </summary>
    public class FetchActiveCustomerEmailOperation : AcisSMEOperation
    {
        /// <summary>
        /// Name of the operation. This is prominently visible from Jarvis. One search an operation by name.
        /// </summary>
        public override string OperationName { get => "Get Active customer Email"; }
        ...
        /// FetchActiveCustomerEmail Operation provides a list of active customer email.
        /// </summary>
        ...
        /// <returns></returns>
        public IAcisSMEOperationResponse FetchActiveCustomerEmail(string resourceId, string tenantId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null) => Common.Utilities.CallOpertionAsync(Constants.FetchActiveCustomerEmailOperationName, extension, updater, endpoint, parameters: Common.Utilities.CombineResourceIdTenantId(resourceId, tenantId)).Result;
    }
}
