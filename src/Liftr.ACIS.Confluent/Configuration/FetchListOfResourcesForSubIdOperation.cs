...
{
    public class FetchListOfResourcesForSubIdOperation : AcisSMEOperation
    {
        /// <summary>
        /// Name of the operation. This is prominently visible from Jarvis. One search an operation by name.
        /// </summary>
        public override string OperationName { get => "Get List of Resources"; }
        ...
        {
            get { return new IAcisSMEParameterRef[] { ParamRefFromParam.Get<SubscriptionIdParameter>() }; }
        }
        ...
        /// <returns></returns>
        public IAcisSMEOperationResponse FetchListOfResourcesForSubId(string subscriptionId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null) => Common.Utilities.CallOpertionAsync(Constants.FetchListOfResourcesOperationName, extension, updater, endpoint, parameters: subscriptionId).Result;
    }
}
