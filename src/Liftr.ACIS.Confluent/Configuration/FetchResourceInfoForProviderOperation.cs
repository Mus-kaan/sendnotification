...
{
    public class FetchResourceInfoForProviderOperation : AcisSMEOperation
    {
        /// <summary>
        /// Name of the operation. This is prominently visible from Jarvis. One search an operation by name.
        /// </summary>
        public override string OperationName { get => "Get List of Resources for a Provider"; }
        ...
        {
            get { return new IAcisSMEParameterRef[] { ParamRefFromParam.Get<TenantIdParameter>(), ParamRefFromParam.Get<ProviderNamespaceParameter>(), ParamRefFromParam.Get<ResourceTypeParameter>(), ParamRefFromParam.Get<APIVersionParameter>() }; }
        }
        ...
        /// </summary>
        /// <param name="tenantId">Tenant Id. This param is picked from Params attribute in the same order</param>
        /// <param name="providerNameSpace">Provider Namespace for User RP</param>
        ...
        /// <returns></returns>
        public IAcisSMEOperationResponse FetchResourceInfoForProvider(string tenantId, string providerNameSpace, string resourceType, string apiVersion, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null) => Common.Utilities.CallOpertionAsync(Constants.FetchResourceInfoForProviderOperationName, extension, updater, endpoint, parameters: Common.Utilities.ConcatParams(tenantId, providerNameSpace, resourceType, apiVersion)).Result;
    }
}
