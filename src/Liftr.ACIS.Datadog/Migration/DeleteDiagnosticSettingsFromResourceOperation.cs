...
namespace Microsoft.Liftr.ACIS
{
    ...
    /// </summary>
    public class DeleteDiagnosticSettingsFromResourceOperation : AcisSMEOperation
    {
        public override string OperationName => "DeleteDiagnosticSettingsFromResource";
        ...
        /// </summary>
        public IAcisSMEOperationResponse DeleteDiagnosticSettingsFromResource(string resourceId, string diagnosticSettingsName, string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            ...
            IAcisSMEEndpoint endpoint = null)
        {
            ...
            var result = await coordinator.StartWorkAsync(nameof(DeleteDiagnosticSettingsFromResource), parameters: ConcatParams(monitoredResourceId, diagnosticSettingsName, monitorId));
            if (result.Succeeded)
            {
