...
{
    public class DeleteSubscriptionOperation : AcisSMEOperation
    {
        public override string OperationName => "DeleteV1Subscription";
        ...
        /// </summary>
        public IAcisSMEOperationResponse DeleteSubscription(string subscriptionId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return DeleteSubscriptionAsync(subscriptionId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> DeleteSubscriptionAsync(string subscriptionId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(DeleteSubscription), parameters: subscriptionId);
            if (result.Succeeded)
            {
