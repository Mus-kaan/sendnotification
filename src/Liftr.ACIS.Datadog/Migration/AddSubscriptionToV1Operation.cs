...
{
    public class AddSubscriptionToV1Operation : AcisSMEOperation
    {
        public override string OperationName => "AddSubscriptionToV1";
        ...
        /// </summary>
        public IAcisSMEOperationResponse AddSubscriptionToV1(string subscriptionId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return AddSubscriptionToV1Async(subscriptionId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> AddSubscriptionToV1Async(string subscriptionId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(AddSubscriptionToV1), parameters: subscriptionId);
            if (result.Succeeded)
            {
