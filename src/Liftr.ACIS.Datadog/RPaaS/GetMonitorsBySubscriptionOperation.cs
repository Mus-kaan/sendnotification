...
namespace Microsoft.Liftr.ACIS
{
    ...
    /// </summary>
    public class GetMonitorsBySubscriptionOperation : AcisSMEOperation
    {
        public override string OperationName => "GetMonitorsBySubscription";
        ...
        /// </summary>
        public IAcisSMEOperationResponse GetMonitorsBySubscription(string subscriptionId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return GetMonitorsBySubscriptionAsync(subscriptionId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> GetMonitorsBySubscriptionAsync(string subscriptionId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(GetMonitorsBySubscription), parameters: subscriptionId);
            if (result.Succeeded)
            {
