...
namespace Microsoft.Liftr.ACIS
{
    ...
    /// </summary>
    public class GetMonitorTagRulesOperation : AcisSMEOperation
    {
        public override string OperationName => "GetMonitorTagRules";
        ...
        /// </summary>
        public IAcisSMEOperationResponse GetMonitorTagRules(string monitorResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return GetMonitorTagRulesAsync(monitorResourceId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> GetMonitorTagRulesAsync(string monitorResourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(GetMonitorTagRules), parameters: monitorResourceId);
            if (result.Succeeded)
            {
