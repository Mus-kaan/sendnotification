...
namespace Microsoft.Liftr.ACIS
{
    ...
    public class GetRelationshipsByResourceOperation : AcisSMEOperation
    {
        ...
        /// </summary>
        public IAcisSMEOperationResponse GetRelationshipsByResource(string resourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return GetRelationshipsByResourceAsync(resourceId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> GetRelationshipsByResourceAsync(string resourceId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(GetRelationshipsByResource), parameters: resourceId);
            if (result.Succeeded)
            {
