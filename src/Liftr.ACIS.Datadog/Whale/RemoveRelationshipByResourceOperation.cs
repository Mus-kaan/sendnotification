...
namespace Microsoft.Liftr.ACIS
{
    ...
    public class RemoveRelationshipByResourceOperation : AcisSMEOperation
    {
        ...
        /// </summary>
        public IAcisSMEOperationResponse RemoveRelationshipByResource(string resourceId, string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return RemoveRelationshipByResourceAsync(resourceId, monitorId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> RemoveRelationshipByResourceAsync(string resourceId, string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
