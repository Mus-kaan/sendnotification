...
namespace Microsoft.Liftr.ACIS
{
    ...
    /// </summary>
    public class GetStatusByResourceOperation : AcisSMEOperation
    {
        public override string OperationName => "GetStatusByResource";
        ...
        /// </summary>
        public IAcisSMEOperationResponse GetStatusByResource(string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return GetStatusByResourceAsync(monitorId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> GetStatusByResourceAsync(string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(GetStatusByResource), parameters: monitorId);
            if (result.Succeeded)
            {
