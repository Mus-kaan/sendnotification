...
namespace Microsoft.Liftr.ACIS
{
    ...
    /// </summary>
    public class GetMaxDiagnosticSettingCountOperation : AcisSMEOperation
    {
        public override string OperationName => "GetMaxDiagnosticSettingCount";
        ...
        /// </summary>
        public IAcisSMEOperationResponse GetMaxDiagnosticSettingCount(string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            return GetMaxDiagnosticSettingCountAsync(monitorId, extension, updater, endpoint).Result;
        }

        private async Task<IAcisSMEOperationResponse> GetMaxDiagnosticSettingCountAsync(string monitorId, IAcisServiceManagementExtension extension = null, IAcisSMEOperationProgressUpdater updater = null, IAcisSMEEndpoint endpoint = null)
        {
            if (extension == null)
            {
            ...
            var result = await coordinator.StartWorkAsync(nameof(GetMaxDiagnosticSettingCount), parameters: monitorId);
            if (result.Succeeded)
            {
